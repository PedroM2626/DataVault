    ...
    <div className="space-y-4 mt-10">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Pergunte sobre seus dados em linguagem natural. Ex.: "traga os 3
            clientes com mais processos em 2025"
          </CardDescription>
        </CardHeader>
          ...
          <Tabs defaultValue="data" className="w-full">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-sm">
                    Resultados ({result.table.rows.length} registros)
                  </CardTitle>
                  <CardDescription>
                    Ordenados por {result.table.valueColumn} desc
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="chart">
              <Card>
                <CardHeader>
                  <CardTitle className="text-sm">
                    Visualização - {result.chart.type.toUpperCase()}
                  </CardTitle>
            ...
            <TabsContent value="sql">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Como interpretei sua pergunta e a SQL gerada
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div>
